...
Gem::Specification.new do |s|
  ...
  s.authors = ["kajyuuen".freeze]
  s.bindir = "exe".freeze
  s.date = "2017-02-06"
  s.description = "Calil api wrapper.".freeze
  s.email = ["kajyuuen@gmail.com".freeze]
  s.homepage = "https://github.com/kajyuuen/calil".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.8".freeze
  s.summary = "Calil api wrapper.".freeze
